...
// Page-specific metadata for Digital Transformation Service Page
export const metadata = {
  title: "Digital Transformation Services | TREBO Consulting",
  description:
    "TREBO Consulting helps organizations across Africa, Europe, and the UK embrace digital transformation. Optimize processes, adopt innovative technologies, and accelerate business growth with our expert IT solutions.",
  keywords: [
    "Digital Transformation Services",
    "TREBO Consulting Digital Solutions",
    "Business Process Optimization",
    "IT Innovation Consulting",
    "Technology Strategy Africa",
    "SAP & IT Services",
  ],
  openGraph: {
    title: "Digital Transformation Services | TREBO Consulting",
    description:
      "Partner with TREBO Consulting to drive your organization’s digital transformation. Our solutions enable process optimization, technology adoption, and measurable business growth.",
    url: "https://www.treboresources.com/services/digital-transformation",
...
function DigitalTransformationComponent() {
  return (
